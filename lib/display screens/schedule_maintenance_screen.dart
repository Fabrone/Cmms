...
class ScheduleMaintenanceScreenState extends State<ScheduleMaintenanceScreen> {
  ...
  Future<void> _saveTask() async {
    ...
    try {
      ...
      await FirebaseFirestore.instance.collection('maintenance_tasks').add(task.toJson());
      ...
      logger.i('Saved task: ${task.toJson()}');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Schedule Maintenance', style: GoogleFonts.poppins(color: Colors.white)),
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            Text('Upload Document', style: GoogleFonts.poppins(fontSize: 18, fontWeight: FontWeight.bold)),
            const SizedBox(height: 8),
            ElevatedButton.icon(
              onPressed: _uploadDocument,
              icon: const Icon(Icons.upload_file),
              label: Text('Select Document', style: GoogleFonts.poppins()),
            ),
            ...
            Row(
              ...
              children: [
                Text('Uploaded Documents', style: GoogleFonts.poppins(fontSize: 16, fontWeight: FontWeight.bold)),
                IconButton(
            ...
            Text('Schedule Task', style: GoogleFonts.poppins(fontSize: 18, fontWeight: FontWeight.bold)),
            const SizedBox(height: 8),
            Form(
              key: _formKey,
              child: Column(
                children: [
                  ...
                  if (_categorySuggestions.isNotEmpty)
                    Container(
                      ...
                      child: ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          return ListTile(
                            title: Text(_categorySuggestions[index], style: GoogleFonts.poppins()),
                            onTap: () {
                              _categoryController.text = _categorySuggestions[index];
                              setState(() {
                                _categorySuggestions = [];
                              });
                              _categoryFocus.unfocus();
                  ...
                  ElevatedButton(
                    onPressed: _saveTask,
                    child: Text('Save Task', style: GoogleFonts.poppins()),
                  ),
                ],
              ),
            ),
