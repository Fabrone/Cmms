...
class _DrawingsScreenState extends State<DrawingsScreen> {
  ...
  Widget build(BuildContext context) {
    _logger.i('Building DrawingsScreen: facilityId=${widget.facilityId}');
    ...
    return ScaffoldMessenger(
      ...
      child: Scaffold(
        appBar: AppBar(
          title: Text(
            'Drawings',
            style: GoogleFonts.poppins(fontSize: isMobile ? 18 : 20),
          ),
        ),
        body: SafeArea(
          child: Padding(
                        ...
                        children: [
                          TextField(
                            ...
                            decoration: const InputDecoration(
                              labelText: 'Drawing PDF Title (Optional)',
                    ...
                    builder: (context, snapshot) {
                      ...
                      return ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          final fileUrl = data != null && data.containsKey('fileUrl')
                              ? data['fileUrl']
                              : data != null && data.containsKey('pdfUrl')
                                  ? doc['pdfUrl']
                                  : null;
